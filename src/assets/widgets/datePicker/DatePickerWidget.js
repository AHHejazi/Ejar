      ...
      //  alert(self.settings.lang + ' ' + self.settings.calendarType);
       ...
       // var yearRangeToApply = eval(rangeString.split(":")[0]) + ":" + eval(rangeString.split(":")[1]);
        ...
        switch (self.settings.rangeType) {
            case "futureOnly":
                // if "futureOnly" minDate is tomorrow.
                minDate = "+1d"; // tomorrow date
                maxDate = "+100y"; // 100 years in future
                break;
            case "futureIncludingToday":
                minDate = 0; // today date
                maxDate = "+100y"; // 100 years in future
                break;
            case "pastOnly":
                minDate = "-100y"; // 100 years in past
                maxDate = "-1d"; // yesterday date
                break;
            case "pastIncludingToday":
                minDate = "-100y"; // 100 years in past
                maxDate = 0; // today date
                break;
            default:
                minDate = "-50y"; // 100 years in past
                maxDate = "+50y"; // 100 years in future
                break;
        }
